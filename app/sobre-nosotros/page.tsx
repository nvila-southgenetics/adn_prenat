...
export const metadata: Metadata = {
  title: 'Sobre Nosotros | Test ADN Prenatal',
  description: 'Conoce más sobre Test ADN Prenatal, nuestra misión y el equipo de profesionales comprometidos con brindarte resultados precisos y confidenciales.',
}
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
                  <p>
                    Test ADN Prenatal nació con una misión clara: ofrecer acceso a pruebas de paternidad prenatal no invasivas de la más alta calidad, con resultados confiables y un servicio completamente confidencial.
                  </p>
                  <p>
                    Entendemos que este momento puede estar lleno de emociones y preguntas. Por eso, nos comprometemos a acompañarte en cada paso del proceso con empatía, profesionalismo y discreción absoluta.
                  </p>
                  <p>
                    Trabajamos con laboratorios certificados internacionalmente que utilizan la tecnología más avanzada en análisis de ADN fetal libre en sangre materna, garantizando resultados con 99.9% de precisión.
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">Laboratorios con certificaciones internacionales</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-ocean-600 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">Acompañamiento personalizado en todo momento</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Utilizamos tecnología de punta y trabajamos con los mejores laboratorios certificados
                </p>
              </div>
              <div className="text-center">
                <div className="w-20 h-20 bg-gradient-to-br from-ocean-500 to-ocean-600 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Nuestro equipo está capacitado para brindarte el mejor servicio en cada etapa
                </p>
              </div>
              <div className="text-center">
                <div className="w-20 h-20 bg-gradient-to-br from-ocean-500 to-ocean-600 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-6 text-left">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                ...
                <p className="text-ocean-100">
                  Análisis de ADN fetal libre en sangre materna, la técnica más moderna y segura
                </p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                ...
                <p className="text-ocean-100">
                  Te acompañamos antes, durante y después del proceso
                </p>
              </div>
            </div>
            <div className="mt-12">
