...
export const metadata: Metadata = {
  ...
  description: `Conocé más sobre SouthGenetics y nuestro servicio de pruebas de paternidad prenatal en ${country.name}. Laboratorio certificado con tecnología de vanguardia.`,
  alternates: {
    canonical: 'https://paternidadprenatal.com/ar/sobre-nosotros',
  },
}

export default function SobreNosotrosArgentinaPage() {
  return (
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
                ...
                <p className="text-gray-600 mt-4">
                  ...
                  o mediante kits de recolección a domicilio.
                </p>
              </div>
