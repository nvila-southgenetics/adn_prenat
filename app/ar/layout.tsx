...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://paternidadprenatal.com/ar/',
    languages: {
  ...
  openGraph: {
    ...
    url: 'https://paternidadprenatal.com/ar/',
    siteName: `Test Paternidad Prenatal ${country.name}`,
    images: [
      {
        url: '/imgs/og-image-ar.jpg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: country.metaTitle,
    description: country.metaDescription,
    images: ['/imgs/twitter-card-ar.jpg'],
  },
}
