          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <Image
                  src="/imgs/logo.png"
                  alt="SouthGenetics - Test Paternidad Prenatal Venezuela"
                  width={150}
                  height={50}
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                Pruebas de paternidad prenatal precisas y seguras para familias en Venezuela.
                Utilizamos tecnología de vanguardia para brindarte resultados confiables y confidenciales en Caracas solamente.
              </p>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h4 className="text-lg font-semibold mb-4">Contacto Venezuela</h4>
        ...
        <div className="border-t border-navy-800">
          <div className="container-custom py-6">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              >
                <p>&copy; 2024 Test ADN Prenatal Venezuela. Todos los derechos reservados.</p>
              </motion.div>
