...
export default function WhatsAppModalVe({ isOpen, onClose }: WhatsAppModalProps) {
          ...
          >
            ...
            <div className="bg-gradient-to-r from-green-500 to-green-600 p-6 text-white relative">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold">Contáctanos por WhatsApp</h3>
            ...
            <div className="p-6 space-y-6">
              <div className="text-center space-y-2">
                <p className="text-gray-600">
                  Nuestro equipo en Venezuela está listo para ayudarte con todas tus consultas sobre la prueba de paternidad prenatal.
                </p>
              ...
              <div className="bg-gray-50 rounded-xl p-4">
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-green-500 mt-0.5">&#10003;</span>
                    Precios y formas de pago en Venezuela
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-500 mt-0.5">&#10003;</span>
              ...
              <p className="text-center text-xs text-gray-400">
                {country.businessHours} (Hora Venezuela)
              </p>
            </div>
          </motion.div>
        </>
