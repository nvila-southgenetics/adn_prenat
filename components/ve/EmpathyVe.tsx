...
export default function EmpathyVe() {
      ...
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Por eso, nuestro equipo en Venezuela está aquí para acompañarte con respeto, 
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Tu privacidad es sagrada. Nadie más que tú tendrá acceso a los resultados. 
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    No eres un número. Nuestro equipo te acompaña en cada paso, 
                    respondiendo tus dudas y brindándote el apoyo que necesitas.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Cada situación es única y válida. Estamos aquí para ayudarte, 
                    no para cuestionar tus decisiones. Cuentas con nuestro apoyo incondicional.
                  </p>
                </div>
              </div>
            </div>
