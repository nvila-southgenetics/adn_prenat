...
export default function ContactCTAVe() {
          ...
          >
            <div>
              ...
              <p className="text-xl text-ocean-100">
                Contáctanos hoy y resuelve tus dudas. Estamos aquí para acompañarte en Venezuela.
              </p>
            </div>
              ...
              <div className="text-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Respuesta inmediata de nuestro equipo en Venezuela. 
                ...
                <p className="text-xs text-gray-400">
                  También puedes completar el{' '}
                  <a href="/ve/formulario" className="text-ocean-600 hover:underline">
