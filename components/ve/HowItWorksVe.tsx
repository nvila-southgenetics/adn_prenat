...
const steps = [
  {
    number: '01',
    title: 'Contáctanos',
    description: 'Escríbenos por WhatsApp o completa el formulario. Te explicamos todo el proceso y resolvemos tus dudas.',
    icon: MessageCircle,
  ...
  },
  {
    ...
    description: 'Agendamos la extracción de sangre de la mamá en un laboratorio aliado cerca de ti o con kit a domicilio.',
    icon: FileText,
  ...
  {
    number: '05',
    title: 'Recibes los resultados',
    description: 'En aproximadamente 10-12 días hábiles, te entregamos los resultados de forma segura y confidencial.',
    icon: FileCheck,
    image: '/imgs/resultados.png'
  }
]

export default function HowItWorksVe() {
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Un proceso simple, seguro y 100% confidencial. Te acompañamos en cada paso desde Venezuela.
          </p>
        </motion.div>
        ...
        >
          <p className="text-lg text-gray-600 mb-6">
            ¿Tienes dudas sobre el proceso? Estamos para ayudarte
          </p>
          <button
            type="button"
