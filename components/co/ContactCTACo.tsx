...
export default function ContactCTACo() {
  return (
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Completa el formulario en 2 sencillos pasos y nuestro equipo se contactará con usted para acompañarlo en el proceso.
          </p>
