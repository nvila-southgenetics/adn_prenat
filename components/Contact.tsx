...
- Semana de gestación: ${formData.semana}`
      ...
      const whatsappUrl = `https://wa.me/525512345678?text=${encodeURIComponent(mensaje)}`
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Estamos aquí para ayudarte. <span className="font-bold text-green-600">Disponibles 24/7</span> para resolver todas tus dudas
          </p>
        </motion.div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">paternidadprenatalmx@ejemplo.com</p>
                  </div>
                </div>
              </div>
            </div>
