...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Aproximadamente 10 días hábiles desde que recibimos la muestra en el laboratorio. Te avisamos apenas estén listos y los enviamos de manera segura y confidencial.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Sí, atendemos en Buenos Aires y Belgrano. La toma de muestra se puede coordinar con laboratorios aliados o mediante kit de recolección a domicilio.'
  }
]
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-lg text-ocean-100 max-w-3xl mx-auto">
            Lo esencial sobre nuestra prueba de paternidad prenatal en Argentina
          </p>
        </motion.div>
        ...
        >
          <div className="bg-white rounded-2xl p-8 shadow-lg max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              Escribinos por WhatsApp y con gusto te acompañamos en lo que sigue.
            </p>
